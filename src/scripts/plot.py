...
def main():
    ...
    try:
        ...
        print(f"Error: Checkpoint not found at {checkpoint_path}. Please run train_model.py first.")
        return
    ...
    final_x, traj = sample(model, n_samples=n_samples, dim=dim, device=device, steps=steps, y=y)
